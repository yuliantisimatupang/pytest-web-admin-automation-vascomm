...
class Test_Vacancies_Scenario_1(Basic_Test):
  ...
  def test_open_url(self):
    ...
    job_placement = select_option(self, job_placement_selector, "On Site Malang")
    job_placement.click()
    ...
    job_status = select_option(self, job_status_selector, "Closed")
    job_status.click()
